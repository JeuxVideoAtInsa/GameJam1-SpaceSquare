...
Crafty.c("Gravity", {
	...
	* ~~~
	*/
	gravity: function (comp, gBox) {
		if (comp) this._anti = comp;
		
		if (gBox) {this._gBox = gBox;}
...
Crafty.c("TwowayJ1", {
	...
	twowayJ1: function (speed, jump) {
		...
		this.bind("EnterFrame", function () {
			...
			if (this.isDown("W") || this.isDown("Z")) this._up = true;
		});
...
Crafty.c("TwowayJ2", {
	...
	twowayJ2: function (speed, jump) {
		...
		this.bind("EnterFrame", function () {
			...
			if (this.isDown("UP_ARROW")) this._up = true;
		});
